        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8" id="book-listt">
            @foreach ($books as $book)
                <div class="rounded-md shadow-md sm:w-96 dark:bg-gray-50 dark:text-gray-800 gallery-item"
                    data-category="{{ $book->book_category_id }}">
                        ...
                        <div class="flex flex-shrink-0 self-center">
                            ...
                            <div
                                ...
                                <div class="py-1" role="none">
                                    ...
                                    <button onclick="openExchangeModal('{{ $book->id }}', '{{ $book->title }}')"
                    ...
                    <img src="{{ asset('storage/images/books/' . $book->image) }}" alt="Book Image"
                    ...
                    <div class="p-3">
                        ...
                        <div class="mt-4">
                            <button onclick="openExchangeModal('{{ $book->id }}', '{{ $book->user_id }}')"
