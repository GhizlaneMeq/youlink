...
<form action="{{ route('books.search') }}" method="POST" class="flex flex-col md:flex-row gap-3">
    @csrf <!-- Add CSRF token -->
    <div class="flex">
        <!-- Search input -->
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8" id="book-listt">
    ...
    <div class="rounded-md shadow-md sm:w-96 dark:bg-gray-50 dark:text-gray-800 gallery-item" data-category="{{$book->book_category_id}}">
        <div class="flex items-center justify-between p-3">
            <a href="{{route('users.show',$book->user_id)}}" class="flex items-center space-x-2">
            ...
            <div class="flex flex-shrink-0 self-center">
                ...
                <div class="options-menu hidden absolute z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div class="py-1" role="none">
                        <a href="{{ route('books.show', $book->id) }}" class="text-gray-700 flex px-4 py-2 text-sm hover:bg-gray-100">
                        ...
                        <button onclick="openExchangeModal('{{ $book->id }}', '{{ $book->title }}')" title="Exchange" type="button" class="options-button text-gray-700 flex px-4 py-2 text-sm hover:bg-gray-100">
        ...
        <img src="{{ asset('storage/images/books/' . $book->image) }}" alt="Book Image" class="object-cover object-center w-full h-72 dark:bg-gray-500">
        <div class="p-3">
