...
<div class="p-20">
    ...
    <div class="sm:grid grid-cols-2 md:grid-cols-4 col-gap-10 mx-auto">
        ...
        <div class="text-center">
            <a href="#"><img class="mb-3 rounded-xl mx-auto h-32 w-32" src="{{asset('Storage/images/users/'.$user->avatar)}}"></a>

            <a href="{{route('users.show', $user->id)}}" class="hover:text-indigo-500 text-gray-500 uppercase  font-semibold">{{ $user->name }}</a>
            <p class="text-gray-500 uppercase text-sm">{{ $user->role }}</p>
