        ...
        <div class="text-gray-300 container mx-auto p-8 overflow-hidden md:rounded-lg md:p-10 lg:p-12">
            <header class='  font-sans min-h-[60px]'>
                <div
                    ...
                    <a href="/"><img src="{{ asset('images/logo.png') }}" alt="logo" class='w-48' />
                    </a>
                    ...
                    <ul id="collapseMenu"
                        class='lg:!flex max-lg:hidden max-lg:w-full lg:space-x-10 max-lg:space-y-3 max-lg:my-4'>
                        <li class='max-lg: max-lg:py-2'><a href='/'
                                class='hover:text-blue-600 font-bold text-[15px] text-blue-500 block'>Home</a>
                        </li>
                        <li class='group max-lg: max-lg:py-2 relative'>
                            <a href='{{ route('books.index') }}'
                                class='hover:text-blue-500 font-bold text-white text-[15px] lg:hover:text-blue-600 block'>Book
                                Swap<svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                            ...
                            <ul
                                ...
                                <li class='py-2'><a href='{{ route('books.index') }}'
                                        class='hover:text-blue-500 font-bold text-white text-[15px] block'>All Books</a>
                                </li>
                                <li class='py-2'><a href='{{ route('user.books.index') }}'
                                        class='hover:text-blue-500 font-bold text-white text-[15px] block'>My Books</a></li>
                                <li class='py-2'><a href='{{ route('user.exchanges.incomingRequests') }}'
                                        class='hover:text-blue-500 font-bold text-white text-[15px] block'>Incoming
                                        Requests</a></li>
                                <li class='py-2'><a href='{{ route('user.exchanges.outgoingRequests') }}'
                                        class='hover:text-blue-500 font-bold text-white text-[15px] block'>Outgoing
                                        Requests</a></li>
                            </ul>
                        </li>
                        <li class='group max-lg: max-lg:py-2 relative'>
                            <a href='{{ route('items.index') }}'
                                class='hover:text-blue-500 font-bold text-white text-[15px] lg:hover:text-blue-600 block'>Discovery
                                Depot<svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
                                    fill='currentColor' class="ml-1 inline-block" viewBox="0 0 24 24">
                                    <path
                                        d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z"
                                        data-name="16" data-original="#000000" />
                            ...
                            <ul
                                ...
                                <li class='py-2'><a href='{{ route('lost_items') }}'
                                        class='hover:text-blue-500 font-bold text-white text-[15px] block'>Lost Items</a>
                                </li>
                                <li class='py-2'><a href='{{ route('found_items') }}'
                                        class='hover:text-blue-500 font-bold text-white text-[15px] block'>Found Items</a>
                                </li>
                                <li class='py-2'><a href='{{ route('user.createLostItem') }}'
                                        class='hover:text-blue-500 font-bold text-white text-[15px] block'>Report Lost
                                        Item</a></li>
                                <li class='py-2'><a href='{{ route('user.createFoundItem') }}'
                        ...
                        <li class='group max-lg: max-lg:py-2 relative'>
                            ...
                            <ul
                                class='absolute hidden group-hover:block shadow-lg max-lg:border max-lg:border-gray-500 bg-gradient-to-br from-gray-900 to-black px-6 pb-4 pt-6 space-y-3 lg:top-5 max-lg:top-8 lg:-left-6 min-w-[250px] z-50'>
                                <li class='py-2'><a href='{{ route('events.index') }}'
                                        class='hover:text-blue-500 font-bold text-white text-[15px] block'>events</a>
                                </li>
                                <li class='py-2'><a href='{{ route('user.reservations') }}'
                    ...
                    <button type="button"
                        ...
                        <img class="w-8 h-8 rounded-full"
                            src="{{ asset('storage/images/users/' . Auth::user()->avatar) }}" alt="user photo">
                    </button>
