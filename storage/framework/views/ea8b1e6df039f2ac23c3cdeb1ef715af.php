...
<?php $__env->startSection('main'); ?>
    <?php if(session('error')): ?>
        <div id="alert-3"
            ...
            <div class="ms-3 text-sm font-medium"><?php echo e(session('error')); ?></div>
            <button type="button"
    ...
    <?php if(session('success')): ?>
        <div id="alert-3"
            ...
            <span class="sr-only">Error</span>
            <div class="ms-3 text-sm font-medium"><?php echo e(session('success')); ?></div>
            <button type="button"
    ...
    <main class="space-y-40 mb-10 mx-auto">
        <div class="flex flex-wrap gap-8 max-w-7xl md:mx-auto pt-32">
            <img src="<?php echo e(asset('storage/images/events/' . $event->image)); ?>" class="w-1/2 rounded" alt="" />
            <div class="p-4">
                <div class="flow-root rounded-lg border border-gray-100 py-3 shadow-sm">
                    <dl class="-my-3 divide-y divide-gray-100 text-sm">
                        ...
                        <div class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                            ...
                            <dd class="text-gray-700 sm:col-span-2">
                                <?php echo e($event->availableSeats); ?>
...
<?php echo $__env->make('layouts.book', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Youcode\OneDrive\Desktop\youlink\resources\views/events/details.blade.php ENDPATH**/ ?>