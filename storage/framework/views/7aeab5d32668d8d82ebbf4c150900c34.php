...
<div class="max-w-4xl mx-auto py-8">
    <div class="bg-gray-900 shadow-md rounded-lg overflow-hidden flex">
        <div class="w-1/3 px-6 py-4">
            <img src="<?php echo e(asset('storage/images/books/' . $book->image)); ?>" alt="Book Image" class="w-full rounded-lg shadow-md">
        </div>
        <div class="w-2/3 px-6 py-4 text-white">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-3xl font-semibold"><?php echo e($book->title); ?></h2>
                <span><?php echo e($book->author); ?></span>
            </div>
            <p class="text-gray-300 leading-relaxed"><?php echo e($book->description); ?></p>
            <div class="mt-4">
                <p class="text-sm text-gray-400">Category: <span class="font-semibold"><?php echo e($book->bookCategory->name); ?></span></p>
                <a href="<?php echo e(route('users.show',$book->user_id)); ?>"><p class="text-sm text-gray-400">Owner: <span class="font-semibold"><?php echo e($book->user->name); ?></span></p></a> 
            </div>
            <div class="mt-6">
                <button onclick="openExchangeModal('<?php echo e($book->id); ?>', '<?php echo e($book->user_id); ?>')" class="bg-blue-500 text-white px-4 py-2 rounded-md shadow-md hover:bg-blue-600">Request Exchange</button>
            </div>
        </div>
    </div>
</div>
