    ...
    <div class="bg-white shadow rounded-sm flex justify-between items-center py-3.5 px-3.5">
        <div class="space-y-2">
            ...
            <div class="flex items-center space-x-2">
                <h1 class="text-xl font-semibold text-black"></h1>
            </div>
        </div>
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex gap-5 px-6 py-4 justify-center">
                                ...
                                <form action="<?php echo e(route('admin.events.update', $event->id)); ?>" method="POST">
                                    ...
                                    <input type="hidden" name="status" value="confirmed"> <!-- Hidden input for changing status to confirmed -->
                                    <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600">Accept</button>
                                </form>
                                <form action="<?php echo e(route('admin.events.update', $event->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="status" value="cancelled"> <!-- Hidden input for changing status to cancelled -->
                                    <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600">Refuse</button>
                                </form>
                            </div>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.adminDash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Youcode\OneDrive\Desktop\youlink\resources\views/admin/events.blade.php ENDPATH**/ ?>