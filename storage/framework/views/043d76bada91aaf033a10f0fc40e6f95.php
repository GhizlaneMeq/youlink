<?php if(auth()->guard()->check()): ?>
            ...
            <header class='  font-sans min-h-[60px]'>
                ...
                <ul id="collapseMenu" class='lg:!flex max-lg:hidden max-lg:w-full lg:space-x-10 max-lg:space-y-3 max-lg:my-4'>
                    ...
                    <ul class='absolute hidden group-hover:block shadow-lg max-lg:border max-lg:border-gray-500 bg-[#232f3e] px-6 pb-4 pt-6 space-y-3 lg:top-5 max-lg:top-8 lg:-left-6 min-w-[250px] z-50'>
                        <li class='py-2'><a href='<?php echo e(route("books.index")); ?>' class='hover:text-blue-500 font-bold text-white text-[15px] block'>All Books</a></li>
                        <li class='py-2'><a href='<?php echo e(route("user.books.index")); ?>' class='hover:text-blue-500 font-bold text-white text-[15px] block'>My Books</a></li>
                        <li class='py-2'><a href='<?php echo e(route("user.exchanges.incomingRequests")); ?>' class='hover:text-blue-500 font-bold text-white text-[15px] block'>Incoming Requests</a></li>
                        <li class='py-2'><a href='<?php echo e(route("user.exchanges.outgoingRequests")); ?>' class='hover:text-blue-500 font-bold text-white text-[15px] block'>Outgoing Requests</a></li>
                    </ul>
                    </li>
                    <li class='group max-lg: max-lg:py-2 relative'>
                    ...
                    <ul
                        class='absolute hidden group-hover:block max-lg:border max-lg:border-gray-500 shadow-lg bg-[#232f3e] px-6 pb-4 pt-6 space-y-3 lg:top-5 max-lg:top-8 lg:-left-6 min-w-[250px]'>
                        <li class=' py-2'><a href='<?php echo e(route('events.index')); ?>' class='hover:text-blue-500 font-bold text-white text-[15px] block'>All events</a></li>
                        <li class=' py-2'><a href='<?php echo e(route('user.reservations')); ?>' class='hover:text-blue-500 font-bold text-white text-[15px] block'>my reservations</a></li>
                ...
                <button type="button"
                            ...
                            <img class="w-8 h-8 rounded-full" src="<?php echo e(asset('storage/images/users/'. Auth::user()->avatar)); ?>" alt="user photo">
                        </button>
    ...
    <?php endif; ?><?php /**PATH C:\Users\Youcode\OneDrive\Desktop\youlink\resources\views/layouts/book.blade.php ENDPATH**/ ?>