                ...
                <div
                    ...
                    <ul id="collapseMenu"
                        ...
                        <li class='group max-lg: max-lg:py-2 relative'>
                            ...
                            <ul
                                ...
                                <li class='py-2'><a href='<?php echo e(route('user.books.index')); ?>'
                                        class='hover:text-blue-500 font-bold text-white text-[15px] block'>My Books</a></li>
                                <li class='py-2'><a href='<?php echo e(route('user.exchanges.incomingRequests')); ?>'
                        ...
                        <li class='group max-lg: max-lg:py-2 relative'>
                            ...
                            <ul
                                ...
                                <li class='py-2'><a href='<?php echo e(route('lost_items')); ?>'
                    ...
                    <button type="button"
                        ...
                        <img class="w-8 h-8 rounded-full"
                            src="<?php echo e(asset('storage/images/users/' . Auth::user()->avatar)); ?>" alt="user photo">
                    </button>
...
<?php endif; ?>
<?php /**PATH C:\Users\Youcode\OneDrive\Desktop\youlink\resources\views/layouts/book.blade.php ENDPATH**/ ?>