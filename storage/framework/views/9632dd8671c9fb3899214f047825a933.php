...
<body class="bg-gradient-to-br from-gray-900 to-black">
    <div class="text-gray-300 container mx-auto p-8 overflow-hidden md:rounded-lg md:p-10 lg:p-12">
        ...
        <div class="flex items-center">
            <div>
                <p class="font-sans text-3xl font-bold text-gray-200 max-w-5xl lg:text-5xl lg:pr-24 md:text-4xl">
                    BookSwap: Connect, Exchange, Read!
                </p>
                <div class="h-5"></div>
                <p class="max-w-2xl font-serif text-lg text-gray-400 md:text-xl">
                    Welcome to BookSwap, where the love for literature meets the thrill of exchange! Dive into our virtual library and unlock a world of endless possibilities
                </p>
            </div>
            <img src="<?php echo e(asset('images/pexels-photo-1907785.jpeg')); ?>" alt="BookSwap Logo" class="mr-4 h-72 w-80">
        </div>
...
</html><?php /**PATH C:\Users\Youcode\OneDrive\Desktop\youlink\resources\views/layouts/index.blade.php ENDPATH**/ ?>