...
<div class="p-20">
    ...
    <div class="sm:grid grid-cols-2 md:grid-cols-4 col-gap-10 mx-auto">
        ...
        <div class="text-center">
            <a href="#"><img class="mb-3 rounded-xl mx-auto h-32 w-32" src="<?php echo e(asset('Storage/images/users/'.$user->avatar)); ?>"></a>

            <a href="<?php echo e(route('users.show', $user->id)); ?>" class="hover:text-indigo-500 text-gray-500 uppercase  font-semibold"><?php echo e($user->name); ?></a>
            <p class="text-gray-500 uppercase text-sm"><?php echo e($user->role); ?></p>
...
<?php echo $__env->make('layouts.book', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Youcode\OneDrive\Desktop\youlink\resources\views/users/index.blade.php ENDPATH**/ ?>