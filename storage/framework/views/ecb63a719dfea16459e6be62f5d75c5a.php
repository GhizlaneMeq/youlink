            ...
            <div class="relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12">
              <div class="flex md:absolute md:inset-y-0 md:left-0 lg:static xl:col-span-2">
                <div class="flex flex-shrink-0 items-center">
                  <a href="/"><img class="block h-8 w-auto" src="<?php echo e(asset('images/logo.png')); ?>"alt="Evento logo"></a>
                </div>
              </div>
...
<?php /**PATH C:\Users\Youcode\OneDrive\Desktop\youlink\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>