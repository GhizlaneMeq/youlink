    ...
    <tbody class="whitespace-nowrap">
      ...
      <tr class="odd:bg-blue-50">
        ...
        <td class="px-6 py-4 text-sm">
          <?php echo e($exchange->receivedBook->title); ?></td>
        </td>

        <td class="px-6 py-4 text-sm">
          <?php echo e($exchange->receivedBook->author); ?></td>
        </td>
        <td class="px-6 py-4 text-sm">
          <div class="flex items-center cursor-pointer">
            <img src='https://readymadeui.com/profile_4.webp' class="w-7 h-7 rounded-full shrink-0" />
            <div class="ml-2">
              <p class="text-sm text-black"><?php echo e($exchange->requester->name); ?></p>
            </div>
          </div>
        </td>
        <td class="px-6 py-4 text-sm">
          <?php echo e($exchange->requestedBook->title); ?></td>
        </td>
        <td class="px-6 py-4 text-sm">
          <?php echo e($exchange->requestedBook->author); ?></td>
        </td>
        <td class="px-6 py-4">
          <?php
          $Color = '';
          ...
          <div class="relative">
            <button class="w-[68px] block text-center py-0.5 border-2 border-<?php echo e($Color); ?> text-<?php echo e($Color); ?> text-xs font-semibold rounded exchange_status" data-exchange-id="<?php echo e($exchange->id); ?>" data-status="<?php echo e($exchange->status); ?>">
                <?php echo e($exchange->status); ?>
...
<?php echo $__env->make('layouts.book', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Youcode\OneDrive\Desktop\youlink\resources\views/user/books/exchange/incoming.blade.php ENDPATH**/ ?>