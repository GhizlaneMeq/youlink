      ...
      <tr class="odd:bg-blue-50">
        ...
        <td class="px-6 py-4 text-sm">
          <div class="flex items-center cursor-pointer">
            ...
            <div class="ml-2">
              <p class="text-sm text-black"><?php echo e($exchange->offerer->name); ?></p>
            </div>
          </div>
        </td>
        <td class="px-6 py-4 text-sm">
          <?php echo e($exchange->offeredBook->title); ?></td>
        </td>
        <td class="px-6 py-4 text-sm">
          <?php echo e($exchange->offeredBook->author); ?></td>
        </td>
        <td class="px-6 py-4">
          <?php
          $Color = '';
...
<?php echo $__env->make('layouts.book', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Youcode\OneDrive\Desktop\youlink\resources\views/user/books/exchange.blade.php ENDPATH**/ ?>